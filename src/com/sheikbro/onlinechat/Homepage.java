...
List nameValuePairs2=new ArrayList<NameValuePair>(3);
				...
				String chatRoomCreationURL="https://web.njit.edu/~hhm4/php_Java/ChatRoomCreation.php";
		...
		if (flagType==2){
			...
			String deleteContactURL=new String("https://web.njit.edu/~hhm4/php_Java/DeleteContact.php");
			MainActivity.centraldb = openOrCreateDatabase(DatabaseHelper.DATABASE_NAME,Context.MODE_PRIVATE,null);
			Cursor e =null;
	...
	String statusUpdateURL="https://web.njit.edu/~hhm4/php_Java/StatusUpdate.php";
		httpClient=new DefaultHttpClient();
