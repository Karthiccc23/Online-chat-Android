...
public class ChatWindow extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		messagePushURL="https://web.njit.edu/~hhm4/php_Java/ChatMessage_Push.php";
		...
		sendButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String sendMessageURL="https://web.njit.edu/~hhm4/php_Java/ChatMessage_Push.php";
	...
	public void upload(String path) throws Exception
	{
		...
		HttpPost httppost = new HttpPost("https://web.njit.edu/~hhm4/php_Java/ChatMessage_Push.php");
