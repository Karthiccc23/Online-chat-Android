...
static Context commonContext;
	...
	public static void updateUsersTable(Context context,SharedPreferences userId){
		...
		aSyncURL="https://web.njit.edu/~hhm4/php_Java/A_UserDetails.php";
...
//             showDialog(progress_bar_type);
		...
		protected String doInBackground(String... params) {
			...
			aSyncURL="https://web.njit.edu/~hhm4/php_Java/A_ContactDetails.php";
...
//             showDialog(progress_bar_type);
		...
		protected String doInBackground(String... params) {
			...
			//SQLiteDatabase db2;
			aSyncURL="https://web.njit.edu/~hhm4/php_Java/A_ChatRoomDetails.php";
			Cursor c=null;
...
//             showDialog(progress_bar_type);
		...
		protected String doInBackground(String... params) {
			...
			aSyncURL="https://web.njit.edu/~hhm4/php_Java/A_ChatMessages.php";
			Cursor c=null;
			c=ASynchronousTasks.db.rawQuery(query1, null);
			if (c!=null){
